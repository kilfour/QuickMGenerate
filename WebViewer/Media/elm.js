...
var $author$project$Main$LogUpdate = $elm$core$Basics$identity;
...
var $author$project$Main$requestLogs = _Platform_outgoingPort(
	'requestLogs',
	function ($) {
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		_List_Nil,
		$author$project$Main$requestLogs(0));
};
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Main$receiveLogs = _Platform_incomingPort('receiveLogs', $elm$json$Json$Decode$value);
var $elm$json$Json$Decode$decodeValue = _Json_run;
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Main$LogEntry = F3(
	function (tags, message, data) {
		return {C: data, D: message, K: tags};
	});
...
var $author$project$Main$logDecoder = A3(
	...
	A3(
		...
		A3(
			...
			$elm$json$Json$Decode$succeed($author$project$Main$LogEntry))));
var $author$project$Main$decoder = $elm$json$Json$Decode$list($author$project$Main$logDecoder);
...
var $author$project$Main$update = F2(
	function (msg, _v0) {
		...
		var entries = function () {
			var _v2 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$decoder, json);
			if (!_v2.$) {
				var success = _v2.a;
				return success;
			} else {
		...
		return _Utils_Tuple2(entries, $elm$core$Platform$Cmd$none);
	});
...
var $author$project$Main$view = function (model) {
	if (!model.b) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Waiting for logs...')
				]));
	} else {
		var logs = model;
		return A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										A2($elm$core$String$join, ', ', entry.K))
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		...
		aA: function (_v0) {
			return $author$project$Main$receiveLogs(
				function (entries) {
					return entries;
				});
		},
