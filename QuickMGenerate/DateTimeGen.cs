...
namespace QuickMGenerate
{
	...
	{
		public static Generator<State, DateTime> DateTime()
		{
			return DateTime(new DateTime(1970, 1, 1), new DateTime(2020, 12, 31));
		}

		public static Generator<State, DateTime> DateTime(DateTime min, DateTime max)
		{
			return
				s =>
					{
						...
						return new Result<State, DateTime>(value, s);
					};
		}
	}
}